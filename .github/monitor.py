...
proc = subprocess.Popen(args.cmd, stdin=subprocess.PIPE, stdout=slave, text=True, start_new_session=True)
os.close(slave)
...
if rtt_success:
    print(sys.argv[0] + ": RT-Thread shell checks passed, OK!")

if state == "empty" and not rtt_success:
