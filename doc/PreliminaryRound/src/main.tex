...
\newcommand{\coverfield}[2]{%
  {\zihao{4}%\heiti
   ...
   \underline{\makebox[\dimexpr\textwidth-6em\relax][l]{\strut #2}}\par}%
}
...
\begin{itemize}
\item 工具脚本编写：自动插入注释、自动修改宏名、将 cor 文件转 bin 并反编译成汇编、自动打包代码、自动移除 dpi 调用、自动替换 Vivado 工程文件为新 Verilog 代码。
