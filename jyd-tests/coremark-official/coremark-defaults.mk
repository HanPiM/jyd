...
COREMARK_DEFAULT_XEXTS := _xmbm_xcrcu8_xlistrev_xmsum_xdfa4p_xlistfind_xmacacc

COREMARK_GCC_MD_SUPPORTED_XEXTS := xbmul xmbm xcrcu8 xlistrev xmsum xdfa4h xdfa4p xlistfind xmacacc
