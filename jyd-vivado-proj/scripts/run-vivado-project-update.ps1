...
$UpdateTcl = Resolve-RequiredPath (Join-Path $ScriptDir "vivado_update_project.tcl")
...
& $VivadoExe -mode batch -source $UpdateTcl -tclargs $ProjectFile $IromDest $DramDest
