...
module jyd_aht10_fpga (
    ...
    always @(posedge clk_50mhz or posedge sensor_reset) begin
        if (sensor_reset) begin
            ...
            status_snapshot      <= {|sensor_error_code, 1'b0, 1'b1};
    ...
    assign status          = {error_sync2 | status_cpu[2], busy_sync2, status_cpu[0]};
    assign temperature_x10 = temperature_cpu;
    assign humidity_x10    = humidity_cpu;
    assign sample_seq      = sample_seq_cpu;
    assign local_temperature_x10 = temperature_snapshot;
    assign local_humidity_x10    = humidity_snapshot;
    assign local_data_valid      = status_snapshot[0];
