...
class EXU(
  ...
  val listReverseQueryAddress = Mux(listReverseStoreRequest, listReverseNext, listReverseCurrent)
  val listReverseCacheQuery = listReverseStoreRequest || listReverseState === ListReverseState.lookup
